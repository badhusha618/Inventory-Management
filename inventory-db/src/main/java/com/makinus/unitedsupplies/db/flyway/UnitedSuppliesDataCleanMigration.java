...
/** Created by abuabdul */
public class UnitedSuppliesDataCleanMigration implements FlywayMigrationStrategy {

  private final Logger LOG = LogManager.getLogger(UnitedSuppliesDataCleanMigration.class);
