...
/** Created by Bad_sha */
public class InventoryDataCleanMigration implements FlywayMigrationStrategy {

  private final Logger LOG = LogManager.getLogger(InventoryDataCleanMigration.class);
