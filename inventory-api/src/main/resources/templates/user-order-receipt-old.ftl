...
<main>
    ...
    <table>
        ...
        <tr>
            ...
            <td class="rate">${productOrder.proQuantity * productOrder.prodSaleRate}</td>
    ...
    <div class="row">
        ...
        <div class="delivery-address">
            <h4>1st Delivery Location</h4>
            <div>${order.delAddressRef}
            </div>
			<#if order.deliveryAddressTwo?has_content>
            <h4>2nd Delivery Location</h4>
            <div>${order.billAddressRef}
            </div><br/>
                <#if order.distanceBetweenLocations?has_content>
                <b>Distance Between Locations ${order.distanceBetweenLocations}</b>
                </#if>
            </#if>
            <br>
            <br>
