...
import com.makinus.unitedsupplies.api.controller.response.CheckoutPriceResponse;
import com.makinus.unitedsupplies.api.controller.response.CheckoutResponse;
import com.makinus.unitedsupplies.api.controller.response.OrderPayloadResponseModel;
import com.makinus.unitedsupplies.api.controller.response.ProductVendorDetail;
import com.makinus.unitedsupplies.api.data.mapping.OrderFulfillmentMapper;
import com.makinus.unitedsupplies.api.data.mapping.OrderMapper;
import com.makinus.unitedsupplies.api.data.mapping.ProductOrderMapper;
...
import com.makinus.unitedsupplies.api.paytm.api.reftype.InitTransactionStatus;
import com.makinus.unitedsupplies.api.razorpay.Prefill;
...
import static com.makinus.unitedsupplies.api.paytm.api.reftype.InitTransactionStatus.SUCCESS;
...
import static com.makinus.unitedsupplies.api.utils.ApiUtils.DEFAULT_DELIVERY_PINCODE;
import static com.makinus.unitedsupplies.api.utils.ApiUtils.INDIAN_CURRENCY;
...
public class CheckoutController {
    ...
    public ResponseEntity<CheckoutResponse> checkoutProducts(@ApiParam("Checkout") @RequestBody CheckoutRequest checkoutRequest) throws UnitedSuppliesException {
    ...
    private CheckoutResponse getCheckoutResponseValues(CheckoutRequest checkoutRequest) throws UnitedSuppliesException {
    ...
    public ResponseEntity<OrderPayloadResponseModel> orderProducts(@ApiParam("Order Request") @RequestBody OrderRequest orderRequest) throws UnitedSuppliesException, IOException, RazorpayException {
    ...
    private RazorpayPayloadResponseModel generateRazorpayPayloadResponse(OrderRequest orderRequest, Order order) throws UnitedSuppliesException {
    ...
    private String generateRequestBody(OrderRequest orderRequest, String orderNo) throws UnitedSuppliesException {
    ...
    public ResponseEntity<CheckoutPriceResponse> processPriceByQuantityAndVendor(@ApiParam("Order Request") @RequestBody CheckoutPriceRequest priceRequest) throws UnitedSuppliesException {
