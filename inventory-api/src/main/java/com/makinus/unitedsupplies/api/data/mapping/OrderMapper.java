...
import com.makinus.unitedsupplies.api.controller.request.OrderRequest;
import com.makinus.unitedsupplies.api.controller.response.OrderResponse;
import com.makinus.unitedsupplies.api.controller.response.ProductOrderResponse;
...
public class OrderMapper implements EntityWithExtraValueMapper<OrderRequest, User, Order>, ListEntityWithExtraValueMapper<List<Order>, Map<Long, List<ProductOrder>>, OrderResponse> {
    ...
    @Override
    public Order mapExtra(OrderRequest orderRequest, final User user) throws UnitedSuppliesException {
    ...
    @Override
    public List<OrderResponse> map(List<Order> orders, Map<Long, List<ProductOrder>> productOrdersMap) throws UnitedSuppliesException {
