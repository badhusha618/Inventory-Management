...
import com.makinus.inventory.api.controller.request.LoginOtpRequest;
import com.makinus.inventory.api.controller.request.LoginRequest;
...
import com.makinus.inventory.api.attribs.Payload;
import com.makinus.inventory.api.config.SecurityConfig;
import com.makinus.inventory.api.data.mapping.MobileUserMapper;
import com.makinus.inventory.api.data.mapping.UserOtpMapper;
...
public class AuthController {
    ...
    @PostMapping("/success")
    public ResponseEntity<User> getAuthToken() throws InventoryException {
    ...
    public ResponseEntity<Base> invokeOTP(@ApiParam("Invoke OTP") @RequestBody LoginOtpRequest loginOtpRequest) throws InventoryException {
    ...
    public ResponseEntity<User> validateLoginOtp(@ApiParam("Validate OTP") @RequestBody(required = false) ValidateOtpRequest validateOtpRequest, HttpServletRequest request) throws IOException, InventoryException {
