...
import com.makinus.inventory.api.controller.request.CartRequest;
import com.makinus.inventory.api.controller.response.CartProductResponse;
import com.makinus.inventory.api.controller.response.CartResponse;
import com.makinus.inventory.api.controller.response.ProductVendorDetail;
import com.makinus.inventory.api.data.mapping.UserCartMapper;
...
public class CartController {
    ...
    public ResponseEntity<CartResponse> getAllCartItems(@ApiParam("User Id") @PathVariable("userId") Long userId) throws InventoryException {
    ...
    public ResponseEntity<CartProductResponse> addCartByUser(@ApiParam("User Id") @PathVariable("userId") Long userId, @ApiParam("Cart") @RequestBody CartRequest cartRequest) throws InventoryException {
    ...
    public ResponseEntity<CartProductResponse> updateCartByUser(@ApiParam("User Id") @PathVariable("userId") Long userId, @ApiParam("Cart") @RequestBody CartRequest cartRequest) throws InventoryException {
    ...
    public ResponseEntity<Base> removeAllProductsFromCartByUser(@ApiParam("User Id") @PathVariable("userId") Long userId) throws InventoryException {
    ...
    public ResponseEntity<Base> removeProductFromCartByUser(@ApiParam("User Id") @PathVariable("userId") Long userId, @ApiParam("Product Id") @PathVariable("productId") Long productId) throws InventoryException {
...
//    private void clubbingTransportCharges (Long userId) throws InventoryException {
