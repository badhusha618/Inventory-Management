...
public class UserCartMapper implements EntityWithExtraValueMapper<CartRequest, Long, UserCart>, EntityUpdateMapper<CartRequest, UserCart> {
    ...
    @Override
    public UserCart mapExtra(CartRequest cartRequest, Long userId) throws InventoryException {
    ...
    @Override
    public UserCart map(CartRequest cartRequest, UserCart userCart) throws InventoryException {
