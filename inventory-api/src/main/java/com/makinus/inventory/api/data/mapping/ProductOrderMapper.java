...
import com.makinus.inventory.api.controller.request.ProductOrderRequest;
...
public class ProductOrderMapper
    ...
    @Override
    public List<ProductOrder> map(List<ProductOrderRequest> productOrderRequests, OrderFulfillment orderFulfillment) throws InventoryException {
