...
public class AttachmentController {
    ...
    public void DownloadProductStatusList(HttpServletResponse response, @ApiParam("Order Ref") @RequestParam String orderRef, @ApiParam("Order Fulfillment Id") @RequestParam String fulfillmentId) throws InventoryException {
    ...
    public void orderReceiptDownload(HttpServletResponse response, @ApiParam("Order Ref") @RequestParam String orderRef) throws InventoryException {
    ...
    public void DownloadServiceCustomerList(HttpServletResponse response, @ApiParam("Order Ref") @RequestParam String orderRef) throws InventoryException {
    ...
    private Map<String, Object> getServiceDetails(Order order) throws InventoryException, ParseException {
        Map<String, Object> model = new HashMap<>();
        LOG.info("Open Approve Confirmation page - {}", this.getClass().getSimpleName());
    ...
    private Map<String, Object> getProductInvoiceDetails(Order order, OrderFulfillment orderFulfillment) throws InventoryException, IOException, TemplateModelException {
