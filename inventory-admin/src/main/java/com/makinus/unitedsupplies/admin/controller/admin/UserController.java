...
import com.makinus.Inventory.admin.data.mapping.AdminUserMapper;
import com.makinus.Inventory.admin.data.service.user.AdminUserService;
...
public class UserController extends MainController {
    ...
    public String userManagement(ModelMap model) throws InventoryException {
    ...
    public String addNewUser(@ModelAttribute("newUserForm") MaterialUserForm newUserForm, RedirectAttributes redirectAttrs) throws InventoryException {
        ...
        LOG.debug("Inventory User Details {}", savedUser.toString());
    ...
    @ResponseBody
    public Boolean isExistingUser(HttpServletRequest request) throws InventoryException {
    ...
    public String updatePassword(@ModelAttribute("changePwdForm") MaterialUserForm changeUserForm, ModelMap model, Principal loggedInUser, RedirectAttributes redirectAttrs) throws InventoryException {
    ...
    public String userSettings(ModelMap model) throws InventoryException {
    ...
    @ResponseBody
    public Map<String, String> changeUserRole(@RequestParam String pk, @RequestParam String value, HttpServletResponse response) throws InventoryException {
    ...
    public String viewUserProfile(@PathVariable("username") String username, ModelMap model) throws InventoryException {
    ...
    public String viewUserProfile(Principal loggedInUser, ModelMap model) throws InventoryException {
        LOG.info("View User Profile - UserController - {}", this.getClass().getSimpleName());
    ...
    @ResponseBody
    public Map<String, String> updateFullName(@RequestParam String pk, @RequestParam String value, HttpServletResponse response) throws InventoryException {
    ...
    @ResponseBody
    public Map<String, String> updateMobile(@RequestParam String pk, @RequestParam String value, HttpServletResponse response) throws InventoryException {
    ...
    @ResponseBody
    public Map<String, String> updateEmail(@RequestParam String pk, @RequestParam String value, HttpServletResponse response) throws InventoryException {
