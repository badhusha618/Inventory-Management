...
public class OrderExcelWriter implements GenericWriter<List<OrderExcelDTO>> {
    ...
    @Override
    public void write(List<OrderExcelDTO> orderExcelDTOS, HttpServletResponse response) throws UnitedSuppliesException {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            throw new UnitedSuppliesException("Exception occurred while exporting order details as excel", io);
        }
    }
