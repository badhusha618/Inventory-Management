...
<div class="service" style="padding-left:20px;padding-right:20px;">
    <div class="border">
        ...
        <center><p class="red">${serviceInvoiceForm.invoiceHeaderDisplay}</p></center>
        ...
        <table class="border">
            <tr>
                <td style="vertical-align:top;width:34%;">
                    ...
                    Invoice No: &nbsp;&nbsp;${serviceInvoiceForm.invoiceNo}<br/>
                    Invoice Date:&nbsp;&nbsp;${serviceInvoiceForm.invoiceDate}<br/>
                    State: &nbsp;&nbsp;Tamilnadu<br/>
                    State Code: &nbsp;&nbsp;33
                </td>
                <td style="vertical-align:top;width:34%;">
